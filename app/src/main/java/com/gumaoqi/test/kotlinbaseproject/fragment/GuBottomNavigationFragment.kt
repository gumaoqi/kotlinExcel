...
class GuBottomNavigationFragment : BaseFragment() {
    ...
    override fun intData() {
        ...
        vm.guBottomNavigationBeanList.add(GuBottomNavigationBean(
                R.id.fragment_gu_bottom_navigation_item_two_ll, "活动", R.drawable.checkbox_pressed, R.drawable.checkbox_normal))
        vm.guBottomNavigationBeanList.add(GuBottomNavigationBean(
                R.id.fragment_gu_bottom_navigation_item_three_ll, "优惠", R.drawable.checkbox_pressed, R.drawable.checkbox_normal))
        vm.guBottomNavigationBeanList.add(GuBottomNavigationBean(
                R.id.fragment_gu_bottom_navigation_item_four_ll, "推荐", R.drawable.checkbox_pressed, R.drawable.checkbox_normal))
        vm.guBottomNavigationBeanList.add(GuBottomNavigationBean(
